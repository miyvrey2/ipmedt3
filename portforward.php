          ...
          <div class="groupd-accordion">
            <section class="selected">
              ...
              <div class="groupd-accordion-section">
                ...
                <h2>Nieuwe applicatie toevoegen</h2>

                  <label for="LanHostIP">LAN Host IP Adres invoeren <?php info("LANHOSTIP"); ?></label>
                  <input type="text" id="LanHostIP" placeholder="xxx.xxx.x.x" class="form-control col-md-1.5"><br />

                  <label for="selectApp">Naam van de applicatie</label>
                  <select id="selectApp">
            ...
            <section>
              ...
              <div class="groupd-accordion-section">
                <h2>Geavanceerde Port-Forward instellingen</h2>

                <label for="appName">Applicatie Naam <?php info("ApplicatieNaam"); ?><br /><sup>(1 ~ 65535)</sup></label>
                <input type="number" id="appName" placeholder="" class="form-control col-md-1.5"><br />

                <label for="protocol">Protocol <?php info("Protocol"); ?>
                <select id="protocol">
                  <option value="7">TCP</option>
                </select>
                <br />

                <label for="startPort">Start Port <?php info("StartPort"); ?><br /><sup>(1 ~ 65535)</sup></label>
                <input type="number" id="startPort" placeholder="" class="form-control col-md-1.5">

                <label for="endPort">End Port <?php info("EndPort"); ?><br /><sup>(1 ~ 65535)</sup></label>
                <input type="number" id="endPort" placeholder="" class="form-control col-md-1.5">

                <label for="startMPort">Start Mapping Port <?php info("StartMappingPort"); ?><br /><sup>(1 ~ 65535)</sup></label>
                <input type="number" id="startMPort" placeholder="" class="form-control col-md-1.5">

                <label for="endMPort">End Mapping Port <?php info("EndMappingPort"); ?><br /><sup>(1 ~ 65535)</sup></label>
                <input type="number" id="endMPort" placeholder="" class="form-control col-md-1.5">
